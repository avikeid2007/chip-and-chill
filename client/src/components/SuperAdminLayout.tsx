...
const links = [
  ...
  { to: "/super-admin/tenants", label: "Tenants", icon: "🏌️" },
];
...
export default function SuperAdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-[240px_1fr]">
      <aside className="bg-ink text-white/85 px-5 py-8 flex flex-col md:sticky md:top-0 md:h-screen">
        <Link to="/" className="font-display font-semibold text-lg text-white flex items-center gap-2 mb-2 px-1">
          <Logo size={22} dark />
          chip &amp; chill
        </Link>
        <div className="eyebrow text-gold mb-8 px-1">Super Admin</div>
        ...
        <div className="pt-5 mt-5 border-t border-white/10">
          <div className="flex items-center gap-3 px-1 mb-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-white truncate">{user?.firstName || "Super admin"}</p>
